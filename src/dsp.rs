...
impl FaustDsp for mydsp {
	...
	fn compute(&mut self, count: i32, inputs: &[&[Self::T]], outputs: &mut[&mut[Self::T]]) {
		...
		for (((input0, input1), output0), output1) in zipped_iterators {
			...
			self.fRec28[0] = -(fSlow34 * (fSlow33 * self.fRec28[1] - (self.fRec13[1] + self.fRec13[2])));
			...
			self.fRec52[0] = fSlow34 * (self.fRec18[1] + self.fRec18[2] - fSlow33 * self.fRec52[1]);
			...
			self.fRec60[0] = -(fSlow34 * (fSlow33 * self.fRec60[1] - (self.fRec20[1] + self.fRec20[2])));
